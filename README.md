...
**Spring Boot Starter for scribejava-apis-ext**

[![Maven Central](https://img.shields.io/maven-central/v/io.github.easy4j/shiro-oauth2-spring-boot-starter)](https://github.com/easy-4-java/shiro-oauth2-spring-boot-starter)
...
> **Artifact ID**：`shiro-oauth2-spring-boot-starter`<br>
> **License**：Apache License 2.0<br>

## 1. Positioning

**shiro-oauth2-spring-boot-starter** is a Spring Boot starter that integrates **scribejava-apis-ext** for applications using scribejava-apis-ext. It provides auto-configuration, property binding, and ready-to-use beans so that applications can consume scribejava-apis-ext capabilities with minimal setup.

| Dimension | Description |
|---|---|
| Type | Spring Boot Starter |
| Consumers | Spring Boot applications using scribejava-apis-ext |
| Core Capabilities | auto-configuration, property binding, ready-to-use beans for scribejava-apis-ext |
| JDK | `17` |
| Coordinates | `io.github.easy4j:shiro-oauth2-spring-boot-starter:4.0.x.20260527-SNAPSHOT` |
| Config Prefix | `shiro.oauth2` |

## 2. Core Capabilities

| Capability | Status | Description |
|---|:---:|---|
| Auto-configuration | ✅ Stable | Registers scribejava-apis-ext beans automatically |
| Property Binding | ✅ Stable | Binds `shiro.oauth2.*` to `ShiroOAuth2Properties` |
| Ready-to-use beans | ✅ Stable | Auto-registered via ShiroOAuth2WebAutoConfiguration |
...
|---|---|---|:---:|---|:---:|
| `shiro.oauth2.enabled` | boolean | `true` | No | Enable the starter | No |
...
```bash
mvn clean verify
mvn -pl shiro-oauth2-spring-boot-starter -am test
```
...
|---|---|---|
| Bean not created | Check auto-configuration report | Verify `shiro.oauth2.enabled=true` and classpath |
...
[Back to top](#readme-top) · [Issues](https://github.com/easy-4-java/shiro-oauth2-spring-boot-starter/issues) · [Repository](https://github.com/easy-4-java/shiro-oauth2-spring-boot-starter)
